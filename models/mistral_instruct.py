...
class Mistral7b_Instruct(LanguageModel):

    "A class to manage the mistralai/Mistral-7B-Instruct-v0.3 model."

    def __init__(self, model_name: str = "mistralai/Mistral-7B-Instruct-v0.3", device='cuda', system_prompt=None, quantization_config=None):
        super().__init__(model_name, system_prompt, device, quantization_config)
        self.template_name = 'mistral'
        self.hidden_dimension = 4096
        self.num_layer = 32
        self.refusal_token_id = [1083] #'I'
        self.load_model()
