...
class Ministral3_14b(LanguageModel):
    """A class to manage the 'mistralai/Ministral-3-14B-Instruct-2512' model."""
    ...
    def _get_text_backbone(self):
        ...
        try:
            ...
            raise AttributeError(
                f"Expected Ministral-3 text backbone at `model.{self.TEXT_BACKBONE_PATH}`."
            ) from exc
    ...
    def load_model(self):
        """
        Ministral-3 override: load with eager attention implementation.
        """
    ...
    def _get_eoi_toks(self):
        ...
        if eos_id is None:
            raise ValueError("Tokenizer does not expose eos_token_id or pad_token_id.")
        return [eos_id]
